...
<head>
  ...
  <link rel="stylesheet" href="<?php bloginfo('template_directory');?>/styles/app.min.css">
  <!-- Load Google fonts, recaptcha and analytics asyncronously -->
  <script type="text/javascript">!function(e,a,t,o,n,s,c,i,r){e.GoogleAnalyticsObject=n,e[n]=e[n]||function(){(e[n].q=e[n].q||[]).push(arguments)},e[n].l=1*new Date,s=a.createElement(t),c=a.getElementsByTagName(t)[0],i=a.createElement(t),r=a.createElement(t),s.async=i.async=r.async=1,s.src=o,i.src="https://ajax.googleapis.com/ajax/libs/webfont/1.6.16/webfont.js",r.src="https://www.google.com/recaptcha/api.js",c.parentNode.insertBefore(s,c),c.parentNode.insertBefore(i,c),c.parentNode.insertBefore(r,c)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create","UA-61070341-1","auto"),ga("send","pageview"),WebFontConfig={google:{families:["Lato:300,400,700,900"]}};var initMap=function(){window.googleMaps=!0};</script>
  <?php wp_head();?>
</head>
