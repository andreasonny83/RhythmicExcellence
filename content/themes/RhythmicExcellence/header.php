...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/main.min.63374ee1.css">
	<script src="<?php echo get_template_directory_uri(); ?>/js/main.min.3a2a18e3.js"></script>
	<?php wp_head(); ?>
</head>
<!-- Google Analytics -->
<script>
