...
<script src="<?php bloginfo('template_directory');?>/scripts/fixElements.js"></script>
<script src="<?php bloginfo('template_directory');?>/scripts/fixImages.js"></script>
<script src="<?php bloginfo('template_directory');?>/scripts/gMap.js"></script>
<script src="<?php bloginfo('template_directory');?>/scripts/readMore.js"></script>
<script src="<?php bloginfo('template_directory');?>/scripts/responsiveMenu.js"></script>
<script src="<?php bloginfo('template_directory');?>/scripts/scrollTop.js"></script>
<script src="<?php bloginfo('template_directory');?>/scripts/submitForm.js"></script>
