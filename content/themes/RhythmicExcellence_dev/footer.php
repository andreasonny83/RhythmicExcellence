<footer class="text-center">
		...
		<div class="social-bar col-md-12">
			...
			<div class="row">
				...
				foreach ( $menu_items as $key => $menu_item ) {
					...
					$output  = "<li class='$li_class'><a href='$url'><i class='materialButton round fa $button_class fa-3x'></i></a></li>";
					echo $output;
				}
				?>
				</ul>
	...
	<div class="bottom">
		<div class="col-md-offset-1 col-md-10 col-sm-12">
			<p>Copyright &copy; 2015 All right reserved. | Powered by <a href="https://github.com/andreasonny83">SonnY</a></p>
		</div>
	</div>
</footer>
