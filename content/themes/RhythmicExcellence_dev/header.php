...
<head>
  ...
  <script type="text/javascript">
    (function(i,s,o,g,r,a,m,wf,gc) {
      i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
        (i[r].q=i[r].q||[]).push(arguments)
      },i[r].l=1*new Date();
      a=s.createElement(o),m=s.getElementsByTagName(o)[0];
      wf=s.createElement(o);
      gc=s.createElement(o);
      a.async=wf.async=gc.async=1;
      a.src=g;
      wf.src='https://ajax.googleapis.com/ajax/libs/webfont/1.6.16/webfont.js';
      gc.src='https://www.google.com/recaptcha/api.js';
      m.parentNode.insertBefore(a,m);
      m.parentNode.insertBefore(wf,m);
      m.parentNode.insertBefore(gc,m);
    })(window,document,'script','//www.google-analytics.com/analytics.js','ga');

    // Google analytics
    ga('create', 'UA-61070341-1', 'auto');
    ga('send', 'pageview');
